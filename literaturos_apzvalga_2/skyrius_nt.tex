...
Tai vaidinama trumpalaike atmintimi, skirtingai nuo lėtai kintančiuose svoriuose esančios ilgalaikės atminties\cite{hochreiter1997}.
Mokant tokį tinklą, atgalinis sklidimas vykdomas per visus sekos elementus.
...
Jos pagrindas yra atminties ląstelė (angl. \textit{memory cell}).
Ji yra tiesinis vienetas su fiksuotu vienetiniu savuoju ryšiu, vadinamas nuolatinės klaidos karusele (angl. \textit{constant error carousel}, CEC).
...
Pirminėje architektūroje ląstelės būsena tik kaupiama: kiekviename žingsnyje prie ankstesnės reikšmės pridedama nauja informacija, bet nėra mechanizmo, kuris būseną atnaujintų ar nunulintų.
...
Sprendimas -- treti, užmaršties vartai (angl. \textit{forget gate}), kurie kiekviename žingsnyje nusprendžia, kokią sukauptos būsenos dalį palikti: nuo visos, iki nulinės, kai būsena visiškai išvaloma.
