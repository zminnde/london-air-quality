...
Vadinasi, joks kitas metodas, turėdamas tuos pačius duomenis, klaidos neįstengtų sumažinti daugiau nei perpus, todėl autoriai teigia, kad vieno artimiausio kaimyno metode slypi pusė visos begalinėje imtyje esančios klasifikavimo informacijos \cite{cover1967}.
...
Svarbu atskirti dvi vietas, kuriose KNN metode gali atsirasti svoriai.
Sąvoka „svertinis KNN“ literatūroje reiškia du visai skirtingus dalykus: svorius požymiams atstumo funkcijos viduje, kaip (\ref{eq:svertinis-euklidas}) formulėje, ir svorius kaimynams sudarant prognozę, kurie aptariami kitame poskyryje.
...
Nustatyta, kad optimalus svoris mažėja tiesiškai didėjant atstumui, o nuo tam tikro atstumo tampa lygus nuliui -- prognozėje dalyvauja tik dalis kaimynų, ir jų skaičius kinta nuo taško prie taško.
...
Regresijoje -- prognozuojamo dydžio reikšmė, laiko eilutėje -- po kaimyno lango sekanti reikšmė.
...
o svorio funkcijos literatūroje siūlomos įvairios.
...
Autorius parodė, kad bent viename mažos mokymo imties pavyzdyje svertinė taisyklė esant k>3 klydo rečiau už paprastą balsavimą ir iškėlė prielaidą, jog taip bus ir kitoms mažoms bei vidutinėms imtims \cite{dudani976}.
...
Paklaida tais atvejais, kai prognozė pateikta, ir padengimu -- dalimi atvejų, kuriems prognozė apskritai pateikta.
...
\cite{geifman2019} pasiūlytas SelectiveNet mokosi prognozuoti ir atsisakyti vienu metu, minimizuodamas paklaidą su naudotojo nurodytu padengimo apribojimu.
