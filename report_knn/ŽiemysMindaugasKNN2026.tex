...
\begin{document}
    ...
    \paragraph{Trūkstamų eilučių šalinimas.}
    Pašalinus CO, atliekama tarpų analizė.
    Analizė parodo, kad 66,9\% visų trūkstamų reikšmių sudaro tarpai, ilgesni nei 24 val. \ref{tab:gap_distribution} lentelėje pateikiamas trūkstamų reikšmių pasiskirstymas pagal tarpo ilgį.
    ...
    \ce{NO} pasižymi labai dideliu maksimumu (max 872,83 \textmu g/m\textsuperscript{3}), 18 kartų didesniu nei mediana. \ce{KD_{2,5}} maksimumas (127,60 \textmu g/m\textsuperscript{3}) daugiau nei 8 kartus didesnis už medianą.
    Tai rodo retų, bet intensyvių taršos epizodų egzistavimą.

    Taip pat pastebimos neigiamos minimalios reikšmės. Fiziškai koncentracija negali būti neigiama.
    Tai matavimų klaidos arba sugadinti duomenys.
    ...
    Sezoniškumą galima būtų įtraukti į K-NN metodą.
    Kaimynų paiešką galima apriboti tuo pačiu sezonu arba mėnesiu, arba sezoninius faktorius įtraukti kaip papildomą svorį Euklido atstumo formulėje.
